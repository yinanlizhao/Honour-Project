...
for index in range(start_id,end_id):
    ...
    if parse_config.dataset == 'acdc' :
        ...
        # file_path=str(cfg.data_path_tr)+'/patient'+str(test_id)+'/patient'+str(test_id)+'_frame01.nii.gz'
        # mask_path=str(cfg.data_path_tr)+'/patient'+str(test_id)+'/patient'+str(test_id)+'_frame01_gt.nii.gz'
        file_path=str(cfg.data_path_corr)+'/corr'+str(test_id)+'/corr'+str(test_id)+'.nii.gz'#+'/patient'+str(test_id)+'_frame01.nii.gz'
        mask_path=str(cfg.data_path_corr)+'/corr'+str(test_id)+'/corr'+str(test_id)+'_gt.nii.gz'
    elif parse_config.dataset == 'prostate_md':
    ...
    save_dir_tmp=str(cfg.data_path_tr_cropped)+'/output'+str(test_id)+'/'
